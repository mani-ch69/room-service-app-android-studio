...
function handleBookingSync(booking) {
  ...
  if (sheet.getLastRow() === 0) {
    var headers = [
      "Room Type", "Room Unit", "Sync Date", "Sync Time", // Requested fields FIRST
  ...
  var rowData = [
    booking.roomType,          // Column A
    booking.roomUnit,          // Column B
    booking.syncDate,          // Column C
    booking.syncTime,          // Column D
